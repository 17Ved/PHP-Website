...
<body>
    ...
    <div class="container">
    <h1> Lets learn PHP for backend</h1>
...
// Declare arrays in php below----
$languages = array("python", "java", "c++", "nodejs", "php");
echo $languages[0];
echo "<br>";
echo $languages[4];
echo "<br>";
...
{
    echo "<br>The value of a languages is:";
    echo $languages[$a];
    $a++;
}
...
{
    echo "<br>The values from foreach loop is :";
    echo $value;
}
echo "<br>";
