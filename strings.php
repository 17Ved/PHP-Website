...
<?php
    ...
    // OR you can write this above line as 
    echo "The length of this string is". $lenn;
    echo "<br>";

    // The below line is example of string concatenation
    echo "The length of this string is". $lenn. "Thank you brother<br>";
    ...
    // to search a position of a word in string
